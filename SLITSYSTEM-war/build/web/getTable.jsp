...
<div class ="row">
    <div class ="column venstreheader">
        <a href="Hovedmeny.html"><img src="C:\Users\Stian\Desktop\Notater\IS-202\SLit-Utvikling\SLITSYSTEM\SLITSYSTEM-war\resources\UiA_logo1.jpg" alt="Uia logo" width="60" height="60"></a>
    </div>
...
<div class="midt">
    ...
    %>
    <h2 align="left"><font><strong>Retrieve data from database in jsp</strong></font></h2>
    ...
    <br><br><br><br>
    <a href="/SLITSYSTEM/Download.html">Nedlasting av fil</a>
