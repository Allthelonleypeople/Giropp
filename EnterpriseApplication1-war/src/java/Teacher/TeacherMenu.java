 ...
 * @author Sindre
 */
@WebServlet(name = "TeacherMenu", urlPatterns = {"/TeacherMenu"})
public class TeacherMenu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<u1><li><a href=\"VisModul.html\">Se moduler</a><li></u1>");
            out.println("<u1><li><a href=\"ShowQuestions.jsp\">Se spørsmål</a><li></u1>");
